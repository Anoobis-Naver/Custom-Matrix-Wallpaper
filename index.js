window.onload = function () {
    ...
    var options = {
        ...
        ui_char_1_text: "ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎ",
        ui_char_2_enable: true,
        ui_char_2_double: false,
        ui_char_2_text: "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
        ui_char_3_enable: true,
        ui_char_3_double: false,
        ui_char_3_text: "アイウエオガギグゲゴザジズゼゾダヂヅデドナニヌネノパピプペポマミムメモヤユヨラリルレロワヰヱヲンヴヵヶ",
        ui_char_4_enable: true,
        ui_char_4_double: false,
        ui_char_4_text: "0123456789",
        ui_char_5_enable: false,
        ui_char_5_double: false,
        ui_char_5_text: "",
        ui_char_6_enable: false,
        ui_char_6_double: false,
        ui_char_6_text: "",
        ui_char_7_enable: false,
        ui_char_7_double: false,
        ui_char_7_text: "",
        ui_char_8_enable: false,
        ui_char_8_double: false,
        ui_char_8_text: "",
        ui_char_9_enable: false,
        ui_char_9_double: false,
        ui_char_9_text: "",
        ui_char_10_enable: false,
        ...
        ui_color_highlightMode: "0",
        ui_logo_logo: "1",
        ui_logo_customLogo: "TEST.png",
        ui_logo_preserveColor: true,
        ui_logo_scale: 0.5,
        ui_logo_position: "left-bottom",
        ui_logo_margin: 0.1,
        ui_logo_positionX: 0,
        ui_logo_positionY: 0,
        ui_logo_colorMode: false,
        ui_logo_color: [1, 1, 1],
